...
#Config
export KUBECONFIG="eksconfigAWS"

#GET VALUES FROM CLOUDFORMATION OUTPUT OF EKS STACK
export EKSName="EKS-azAnsjtFcvjj"
export ControlPlaneProvisionRoleArn="arn:aws:iam::893612263489:role/eks-tmp-021931-EKSStack-Y-ControlPlaneProvisionRol-1T08O745IY1Y0"

#Node SSH
export KEY="docker1.pem"
export BASTION="52.72.252.35"
