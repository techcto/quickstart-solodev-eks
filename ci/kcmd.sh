...
#Config
export KUBECONFIG="eksconfig1"

#GET VALUES FROM CLOUDFORMATION OUTPUT OF EKS STACK
export EKSClusterName="EKS-7K5OSAL8"
export SysOpsAdminRoleArn="arn:aws:iam::501911125390:role/eks5-SysOpsAdminRole-XE7BCO709BHF"
...
#Solodev
export RELEASE="solodev-aws"
export NAMESPACE="solodev-dev"
...
test(){
    kubectl --kubeconfig=$KUBECONFIG describe apiservices v1beta1.metrics.k8s.io
}
