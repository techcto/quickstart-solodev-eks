...
def enable_weave(cluster_name):
    ...
    logger.debug(run_command('curl --location -o /tmp/weave-net.yaml "https://cloud.weave.works/k8s/net?k8s-version=$(/usr/local/bin/kubectl --kubeconfig $KUBECONFIG version | base64 | tr -d \'\n\')"'))
